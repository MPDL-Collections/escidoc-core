 ...
 * implemented by {@link Hibernate4Template}. Not often used, but a useful
 ...
 * @since 4.0.1
 * @see Hibernate4Template
 * @see org.hibernate.Session
 * @see HibernateTransactionManager
 */
public interface Hibernate4Operations {
     ...
     * @see org.hibernate.Session
     */
    <T> T execute(Hibernate4Callback<T> action) throws DataAccessException;
