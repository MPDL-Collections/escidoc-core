 ...
 * {@link org.springframework.orm.hibernate4.Hibernate4Template} based on it to
 ...
 * @see org.springframework.orm.hibernate4.Hibernate4Template
 */
public abstract class Hibernate4DaoSupport extends DaoSupport {

    private Hibernate4Template hibernateTemplate;
     ...
     * @see #setSessionFactory
     */
    protected Hibernate4Template createHibernateTemplate(SessionFactory sessionFactory) {
        return new Hibernate4Template(sessionFactory);
    }
     ...
     * @see #setSessionFactory
     */
    public final void setHibernateTemplate(Hibernate4Template hibernateTemplate) {
     ...
     */
    public final Hibernate4Template getHibernateTemplate() {
