 ...
 * implementing the {@link Hibernate4Callback} interface. It provides Hibernate Session
 ...
 */
public class Hibernate4Template implements Hibernate4Operations, InitializingBean {
     ...
     */
    public Hibernate4Template(SessionFactory sessionFactory) {
    ...
    @Override
    public <T> T execute(Hibernate4Callback<T> action) throws DataAccessException {
     ...
     */
    public <T> T executeWithNativeSession(Hibernate4Callback<T> action) {
     ...
     * @throws org.springframework.dao.DataAccessException in case of Hibernate errors
     */
    protected <T> T doExecute(Hibernate4Callback<T> action, boolean enforceNativeSession) throws DataAccessException {
        ...
        try {
            ...
            //No spring-managed session, start transaction
            if (isNew) {
    ...
    public <T> T get(final Class<T> entityClass, final Serializable id, final LockMode lockMode)
        ...
        return executeWithNativeSession(new Hibernate4Callback<T>() {
            @Override
    ...
    public Object get(final String entityName, final Serializable id, final LockMode lockMode)
        ...
        return executeWithNativeSession(new Hibernate4Callback<Object>() {
            @Override
    ...
    public <T> List<T> loadAll(final Class<T> entityClass) throws DataAccessException {
        return executeWithNativeSession(new Hibernate4Callback<List<T>>() {
            @Override
            @SuppressWarnings("unchecked")
    ...
    public void load(final Object entity, final Serializable id) throws DataAccessException {
        executeWithNativeSession(new Hibernate4Callback<Object>() {
            @Override
            public Object doInHibernate(Session session) throws HibernateException {
    ...
    public boolean contains(final Object entity) throws DataAccessException {
        return executeWithNativeSession(new Hibernate4Callback<Boolean>() {
            @Override
    ...
    public Serializable save(final Object entity) throws DataAccessException {
        return executeWithNativeSession(new Hibernate4Callback<Serializable>() {
            @Override
    ...
    public List<?> find(final String queryString, final Object... values) throws DataAccessException {
        return executeWithNativeSession(new Hibernate4Callback<List<?>>() {
            @Override
            @SuppressWarnings("unchecked")
    ...
    public List<?> findByNamedQueryAndNamedParam(
        final String queryName, final String[] paramNames, final Object[] values) throws DataAccessException {
        ...
        return executeWithNativeSession(new Hibernate4Callback<List<T>>() {
            ...
            public List<T> doInHibernate(Session session) throws HibernateException {
                Criteria executableCriteria =
                    (entityName != null ? session.createCriteria(entityName) : session.createCriteria(exampleEntity
                        .getClass()));
    ...
    public Iterator<?> iterate(final String queryString, final Object... values) throws DataAccessException {
        return executeWithNativeSession(new Hibernate4Callback<Iterator<?>>() {
            @Override
            @SuppressWarnings("unchecked")
    ...
    public int bulkUpdate(final String queryString, final Object... values) throws DataAccessException {
        return executeWithNativeSession(new Hibernate4Callback<Integer>() {
            @Override
