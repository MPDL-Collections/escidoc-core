...
/**
 * Item specific implementation of XmlTemplateProvider using the velocity template engine.<br> This implementation uses
...
public class ItemXmlProvider extends InfrastructureXmlProvider {
    ...
    public static final String COMPONENT_ROOT_ATTRIBUTES_RESOURCE_NAME = "componentRootAttributes";

    public static final String COMPONENT_PATH = COMPONENTS_PATH;

    public static final String COMPONENT_PROPERTIES_RESOURCE_NAME = "componentProperties";

    public static final String COMPONENT_PROPERTIES_PATH = COMPONENTS_PATH;

    public static final String COMPONENT_CONTENT_RESOURCE_NAME = "componentContent";
    ...
    public static final String ITEM_LIST_ENTRY_WITHDRAWN_RESOURCE_NAME = "itemlistEntryWithdrawn";
