...
-Configuration-files for one index used by fedoragsearch are:
 (Please copy files from an existing index-configuration and modify)
    ...
    -index.properties, containing properties for the index
        -Properties are:
            -fgsindex.indexName: 
              name of the index, according to name stated in fedoragsearch.properties
            -fgsindex.defaultUpdateIndexDocXslt: 
              Name of the stylesheet used to 
            ...
            -fgsindex.indexDir: 
              Directory where the index-files should get written.
