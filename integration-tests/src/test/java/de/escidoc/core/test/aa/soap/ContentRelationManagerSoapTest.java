...
/**
 * Test suite for the role ContentRelationManager using the SOAP interface.
 *
 * @author Michael Hoppe
 */
@RunWith(Parameterized.class)
public class ContentRelationManagerSoapTest extends ContentRelationManagerAbstractTest {
     ...
     */
    public ContentRelationManagerSoapTest(final int handlerCode, final String userOrGroupId) throws Exception {
