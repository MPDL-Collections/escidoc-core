...
import de.escidoc.core.test.aa.UserAccountAdminAbstractTest;
import de.escidoc.core.test.common.client.servlet.Constants;
import de.escidoc.core.test.security.client.PWCallback;

/**
 * Test suite for the role user-account-administrator using the SOAP interface.
 *
 * @author Michael Hoppe
 */
@RunWith(Parameterized.class)
public class UserAccountAdminSoapTest extends UserAccountAdminAbstractTest {
     ...
     */
    public UserAccountAdminSoapTest(final int handlerCode, final String userOrGroupId) throws Exception {
