...
public class UserGroupInspectorSoapTest extends UserGroupInspectorAbstractTest {
     ...
     */
    public UserGroupInspectorSoapTest(final int handlerCode, final String userOrGroupId) throws Exception {
