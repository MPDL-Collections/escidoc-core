...
import de.escidoc.core.test.aa.ContextModifierAbstractTest;
...
public class ContextModifierSoapTest extends ContextModifierAbstractTest {
     ...
     */
    public ContextModifierSoapTest(final int handlerCode, final String userOrGroupId) throws Exception {
