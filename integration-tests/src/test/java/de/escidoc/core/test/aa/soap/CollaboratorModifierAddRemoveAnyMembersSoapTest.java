...
/**
 * Test suite for the role CollaboratorModifierAddRemoveAnyMembers using the SOAP interface.
 *
 * @author Michael Hoppe
 */
@RunWith(Parameterized.class)
public class CollaboratorModifierAddRemoveAnyMembersSoapTest
     ...
     */
    public CollaboratorModifierAddRemoveAnyMembersSoapTest(final int handlerCode, final String userOrGroupId)
        throws Exception {
