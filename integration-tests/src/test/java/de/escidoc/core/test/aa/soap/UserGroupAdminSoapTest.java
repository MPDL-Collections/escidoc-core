...
public class UserGroupAdminSoapTest extends UserGroupAdminAbstractTest {
     ...
     */
    public UserGroupAdminSoapTest(final int handlerCode, final String userOrGroupId) throws Exception {
