...
/**
 * Test suite for the role CollaboratorModifierAddRemoveAnyMembers a using the REST interface.
 *
...
public class CollaboratorModifierAddRemoveAnyMembersRestTest
     ...
     */
    public CollaboratorModifierAddRemoveAnyMembersRestTest(final int handlerCode, final String userOrGroupId)
        throws Exception {
    ...
    public void testRetrieveContentWithContainerScope() throws Exception {
        ...
        doTestCreateGrant(null, grantCreationUserOrGroupId, containerHref2,
            ROLE_HREF_COLLABORATOR_MODIFIER_ADD_REMOVE_ANY_MEMBERS, null);
