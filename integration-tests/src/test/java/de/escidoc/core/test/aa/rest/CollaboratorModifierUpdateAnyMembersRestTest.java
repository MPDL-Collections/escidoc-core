...
/**
 * Test suite for the role CollaboratorModifierUpdateAnyMembers a using the REST interface.
 *
 * @author Michael Hoppe
 */
@RunWith(Parameterized.class)
public class CollaboratorModifierUpdateAnyMembersRestTest extends CollaboratorModifierUpdateAnyMembersAbstractTest {
     ...
     */
    public CollaboratorModifierUpdateAnyMembersRestTest(final int handlerCode, final String userOrGroupId)
        throws Exception {
    ...
    public void testRetrieveContentWithContainerScope() throws Exception {
        ...
        doTestCreateGrant(null, grantCreationUserOrGroupId, containerHref2,
            ROLE_HREF_COLLABORATOR_MODIFIER_UPDATE_ANY_MEMBERS, null);
     ...
     */
    @Test
    public void testRetrieveContentWithParentContainerScope() throws Exception {
    ...
    public void testRetrieveContentWithNoScope() throws Exception {
        ...
        doTestCreateGrant(null, grantCreationUserOrGroupId, null, ROLE_HREF_COLLABORATOR_MODIFIER_UPDATE_ANY_MEMBERS,
            null);
