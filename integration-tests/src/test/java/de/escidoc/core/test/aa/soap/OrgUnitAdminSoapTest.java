...
public class OrgUnitAdminSoapTest extends OrgUnitAdminAbstractTest {
     ...
     */
    public OrgUnitAdminSoapTest(final int handlerCode, final String userOrGroupId) throws Exception {
