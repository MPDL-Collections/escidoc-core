...
public class RoleSoapTest extends RoleAbstractTest {
    ...
    public void testAACro19_soap() throws Exception {
        ...
        Document toBeCreatedDocument =
            EscidocRestSoapTestBase.getTemplateAsDocument(TEMPLATE_ROLE_PATH, "role_for_create_soap_read_only.xml");
        Document createdDocument = createSuccessfully("role_for_create_soap_read_only.xml");
    ...
    public void testAACro6_soap() throws Exception {
        ...
        addAttribute(toBeCreatedDocument, XPATH_ROLE, createAttributeNode(toBeCreatedDocument, XLINK_NS_URI,
            XLINK_PREFIX_TEMPLATES, EscidocTestBase.NAME_TITLE, "Some Value"));
    ...
    public void testAACro7_soap() throws Exception {
        ...
        Document toBeCreatedDocument =
            EscidocRestSoapTestBase.getTemplateAsDocument(TEMPLATE_ROLE_PATH, "role_for_create.xml");
        addAttribute(toBeCreatedDocument, XPATH_ROLE, createAttributeNode(toBeCreatedDocument, XLINK_NS_URI,
            XLINK_PREFIX_TEMPLATES, EscidocTestBase.NAME_HREF, "http://www.escidoc.de"));
        insertUniqueRoleName(toBeCreatedDocument);
    ...
    public void testAACro8_soap() throws Exception {
        ...
        Document toBeCreatedDocument =
            EscidocRestSoapTestBase.getTemplateAsDocument(TEMPLATE_ROLE_PATH, "role_for_create.xml");
        addAttribute(toBeCreatedDocument, XPATH_ROLE, createAttributeNode(toBeCreatedDocument, XLINK_NS_URI,
            XLINK_PREFIX_TEMPLATES, EscidocTestBase.NAME_TYPE, "simple"));
        insertUniqueRoleName(toBeCreatedDocument);
    ...
    public void testAAUro16_soap() throws Exception {
        ...
        deleteAttribute(toBeUpdatedDocument, XPATH_ROLE_CREATED_BY, EscidocTestBase.NAME_OBJID);
        ...
        try {
            updatedXml = update(getObjidValue(toBeUpdatedDocument), toBeUpdatedXml);
        }
        catch (final Exception e) {
    ...
    public void testAAUro31_soap() throws Exception {
        ...
        // root attribute
        final Document toBeUpdatedDocument = (Document) substitute(createdDocument, XPATH_ROLE_OBJID, "some:objid");
        ...
        // created-by
        substitute(toBeUpdatedDocument, XPATH_ROLE_CREATED_BY_OBJID, "some:objid");

        // modified-by
        substitute(toBeUpdatedDocument, XPATH_ROLE_MODIFIED_BY_OBJID, "some:objid");
        ...
        assertXmlValidRetrievedRole(updatedXml, toBeUpdatedXml, startTimestamp, timestampBeforeLastModification, false);
    ...
    public void testAAUro32_soap() throws Exception {
        ...
        // root attributes
        toBeUpdatedDocument = (Document) deleteAttribute(toBeUpdatedDocument, XPATH_ROLE_OBJID);
