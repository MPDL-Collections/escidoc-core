...
public class CollaboratorModifierAddRemoveMembersRestTest extends CollaboratorModifierAddRemoveMembersAbstractTest {
     ...
     */
    public CollaboratorModifierAddRemoveMembersRestTest(final int handlerCode, final String userOrGroupId)
        throws Exception {
