...
import de.escidoc.core.test.aa.StatisticEditorAbstractTest;
...
/**
 * Test suite for the role StatisticEditor using the SOAP interface.
 *
 * @author Torsten Tetteroo
 */
@RunWith(Parameterized.class)
public class StatisticEditorSoapTest extends StatisticEditorAbstractTest {
     ...
     */
    public StatisticEditorSoapTest(final int handlerCode, final String userOrGroupId) throws Exception {
