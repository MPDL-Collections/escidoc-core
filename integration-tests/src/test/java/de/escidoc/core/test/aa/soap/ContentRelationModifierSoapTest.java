...
/**
 * Test suite for the role ContentRelationModifier using the SOAP interface.
 *
...
public class ContentRelationModifierSoapTest extends ContentRelationModifierAbstractTest {
     ...
     */
    public ContentRelationModifierSoapTest(final int handlerCode, final String userOrGroupId) throws Exception {
