...
/**
 * Test suite for the role StatisticEditor using the REST interface.
 *
 * @author Torsten Tetteroo
 */
@RunWith(Parameterized.class)
public class StatisticEditorRestTest extends StatisticEditorAbstractTest {
     ...
     */
    public StatisticEditorRestTest(final int handlerCode, final String userOrGroupId) throws Exception {
