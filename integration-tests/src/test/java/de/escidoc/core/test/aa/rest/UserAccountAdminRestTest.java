...
/**
 * Test suite for the role user-account-administrator using the REST interface.
 *
 * @author Michael Hoppe
 */
@RunWith(Parameterized.class)
public class UserAccountAdminRestTest extends UserAccountAdminAbstractTest {
     ...
     */
    public UserAccountAdminRestTest(final int handlerCode, final String userOrGroupId) throws Exception {
