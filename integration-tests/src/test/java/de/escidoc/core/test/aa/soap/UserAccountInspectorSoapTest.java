...
/**
 * Test suite for the role user-account-inspector using the SOAP interface.
 *
...
public class UserAccountInspectorSoapTest extends UserAccountInspectorAbstractTest {
     ...
     */
    public UserAccountInspectorSoapTest(final int handlerCode, final String userOrGroupId) throws Exception {
