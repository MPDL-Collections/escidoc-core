...
public class UserAccountInspectorRestTest extends UserAccountInspectorAbstractTest {
     ...
     */
    public UserAccountInspectorRestTest(final int handlerCode, final String userOrGroupId) throws Exception {
