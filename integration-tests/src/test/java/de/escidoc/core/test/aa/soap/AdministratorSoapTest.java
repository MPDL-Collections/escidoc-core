...
/**
 * Test suite for the role Administrator using the SOAP interface.
 *
...
public class AdministratorSoapTest extends AdministratorAbstractTest {
     ...
     */
    public AdministratorSoapTest(final int handlerCode, final String userOrGroupId) throws Exception {
