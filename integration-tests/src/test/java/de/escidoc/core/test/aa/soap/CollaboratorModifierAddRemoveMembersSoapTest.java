...
import de.escidoc.core.test.aa.CollaboratorModifierAddRemoveMembersAbstractTest;
import de.escidoc.core.test.common.client.servlet.Constants;
import de.escidoc.core.test.security.client.PWCallback;

/**
 * Test suite for the role CollaboratorModifierAddRemoveMembers using the SOAP interface.
 *
 * @author Michael Hoppe
 */
@RunWith(Parameterized.class)
public class CollaboratorModifierAddRemoveMembersSoapTest extends CollaboratorModifierAddRemoveMembersAbstractTest {
     ...
     */
    public CollaboratorModifierAddRemoveMembersSoapTest(final int handlerCode, final String userOrGroupId)
        throws Exception {
