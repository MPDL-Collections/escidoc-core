...
/**
 * Test suite for testing access-rights to statistic-reports using the REST interface.
 *
...
public class StatisticReaderRestTest extends StatisticReaderAbstractTest {
     ...
     */
    public StatisticReaderRestTest(final int handlerCode, final String userOrGroupId) throws Exception {
