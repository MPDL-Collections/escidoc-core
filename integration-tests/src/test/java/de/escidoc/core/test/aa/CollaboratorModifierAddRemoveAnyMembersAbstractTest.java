...
public class CollaboratorModifierAddRemoveAnyMembersAbstractTest extends GrantTestBase {
     ...
     */
    public CollaboratorModifierAddRemoveAnyMembersAbstractTest(final int transport, final int handlerCode,
    ...
    /**
     * Test CollaboratorModifierAddRemoveAnyMembers retrieving an item with scope on container.
     *
     * @throws Exception If anything fails.
     */
    @Test
    public void testRetrieveItemWithContainerScope() throws Exception {
        doTestRetrieveWithRole(grantCreationUserOrGroupId, ROLE_HREF_COLLABORATOR_MODIFIER_ADD_REMOVE_ANY_MEMBERS,
            containerHref2, HANDLE, ITEM_HANDLER_CODE, itemId, true, null);
    }

    /**
     * Test CollaboratorModifierAddRemoveAnyMembers retrieving an item with scope on parent container.
     *
     * @throws Exception If anything fails.
     */
    @Test
    ...
    /**
     * Test CollaboratorModifierAddRemoveAnyMembers retrieving an item with no scope.
     *
     * @throws Exception If anything fails.
     */
    @Test
    public void testRetrieveItemWithNoScope() throws Exception {
        doTestRetrieveWithRole(grantCreationUserOrGroupId, ROLE_HREF_COLLABORATOR_MODIFIER_ADD_REMOVE_ANY_MEMBERS,
            null, HANDLE, ITEM_HANDLER_CODE, itemId, true, AuthorizationException.class);
    }

    /**
     * Test CollaboratorModifierAddRemoveAnyMembers retrieving an container with scope on container.
     *
     * @throws Exception If anything fails.
     */
    @Test
    ...
    /**
     * Test CollaboratorModifierAddRemoveAnyMembers retrieving an container with scope on parent container.
     *
     * @throws Exception If anything fails.
     */
    @Test
    ...
    /**
     * Test CollaboratorModifierAddRemoveAnyMembers updating an item with scope on container.
     *
     * @throws Exception If anything fails.
     */
    @Test
    public void testUpdateItemWithContainerScopeDecline() throws Exception {
        doTestUpdateWithRole(grantCreationUserOrGroupId, ROLE_HREF_COLLABORATOR_MODIFIER_ADD_REMOVE_ANY_MEMBERS,
            containerHref2, HANDLE, ITEM_HANDLER_CODE, itemId, "semiconductor surfaces", " u",
            AuthorizationException.class);
    }

    /**
     * Test CollaboratorModifierAddRemoveAnyMembers updating an item with scope on parent container.
     *
     * @throws Exception If anything fails.
     */
    @Test
    ...
    /**
     * Test CollaboratorModifierAddRemoveAnyMembers updating an item with no scope.
     *
     * @throws Exception If anything fails.
     */
    @Test
    public void testUpdateItemWithNoScope() throws Exception {
        doTestUpdateWithRole(grantCreationUserOrGroupId, ROLE_HREF_COLLABORATOR_MODIFIER_ADD_REMOVE_ANY_MEMBERS, null,
            HANDLE, ITEM_HANDLER_CODE, itemId, "semiconductor surfaces", " u", AuthorizationException.class);
    }

    /**
     * Test CollaboratorModifierAddRemoveAnyMembers updating an container with scope on container.
     *
     * @throws Exception If anything fails.
     */
    @Test
    ...
    /**
     * Test CollaboratorModifierAddRemoveAnyMembers updating an container with scope on parent container.
     *
     * @throws Exception If anything fails.
     */
    @Test
    ...
    /**
     * Test CollaboratorModifierAddRemoveAnyMembers updating an container with scope on child-container.
     *
     * @throws Exception If anything fails.
     */
    @Test
    ...
    /**
     * Test CollaboratorModifierAddRemoveAnyMembers updating an container with no scope.
     *
     * @throws Exception If anything fails.
     */
    @Test
    ...
    /**
     * Test CollaboratorModifierAddRemoveAnyMembers locking/unlocking an item with scope on container.
     *
     * @throws Exception If anything fails.
     */
    @Test
    public void testLockUnlockItemWithContainerScopeDecline() throws Exception {
        doTestLockUnlockWithRole(grantCreationUserOrGroupId, ROLE_HREF_COLLABORATOR_MODIFIER_ADD_REMOVE_ANY_MEMBERS,
            containerHref2, HANDLE, ITEM_HANDLER_CODE, itemId, AuthorizationException.class);
    }

    /**
     * Test CollaboratorModifierAddRemoveAnyMembers locking/unlocking an item with scope on parent container.
     *
     * @throws Exception If anything fails.
     */
    @Test
    ...
    /**
     * Test CollaboratorModifierAddRemoveAnyMembers locking/unlocking an item with no scope.
     *
     * @throws Exception If anything fails.
     */
    @Test
    ...
    /**
     * Test CollaboratorModifierAddRemoveAnyMembers locking/unlocking an container with scope on container.
     *
     * @throws Exception If anything fails.
     */
    @Test
    ...
    /**
     * Test CollaboratorModifierAddRemoveAnyMembers locking/unlocking an container with scope on parent container.
     *
     * @throws Exception If anything fails.
     */
    @Test
    ...
    /**
     * Test CollaboratorModifierAddRemoveAnyMembers locking/unlocking an container with scope on child-container.
     *
     * @throws Exception If anything fails.
     */
    @Test
    ...
    /**
     * Test CollaboratorModifierAddRemoveAnyMembers locking/unlocking an container with no scope.
     *
     * @throws Exception If anything fails.
     */
    @Test
    ...
    /**
     * Test CollaboratorModifierAddRemoveAnyMembers adding an item to a container with scope on container.
     *
     * @throws Exception If anything fails.
     */
    @Test
    public void testAddItemToContainerWithContainerScope() throws Exception {
        doTestAddMemberWithRole(grantCreationUserOrGroupId, ROLE_HREF_COLLABORATOR_MODIFIER_ADD_REMOVE_ANY_MEMBERS,
            containerHref, HANDLE, ITEM_HANDLER_CODE, containerId, null);
    }

    /**
     * Test CollaboratorModifierAddRemoveAnyMembers adding an item to a container with scope on parent container.
     *
     * @throws Exception If anything fails.
     */
    @Test
