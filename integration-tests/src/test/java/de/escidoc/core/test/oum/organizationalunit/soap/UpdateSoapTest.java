...
public class UpdateSoapTest extends OrganizationalUnitTestBase {
    ...
    /**
     * Test successfully updating an organizational unit with changed read only attributes and elements via SOAP.
     *
    ...
    public void testOumUou3_soap() throws Exception {
        ...
        final Document toBeUpdatedDocument =
            (Document) substitute(createdDocument, XPATH_ORGANIZATIONAL_UNIT_OBJID, "Some:Objid");

        // creation-date
        substitute(createdDocument, XPATH_ORGANIZATIONAL_UNIT_CREATION_DATE, getNowAsTimestamp());

        // created-by
        substitute(createdDocument, XPATH_ORGANIZATIONAL_UNIT_CREATED_BY_OBJID, "Some:Objid");

        // modified-by
        substitute(createdDocument, XPATH_ORGANIZATIONAL_UNIT_MODIFIED_BY_OBJID, "Some:Objid");
    ...
    /**
     * Test successfully updating an organizational unit without read only attributes and elements via SOAP.
     *
     * @throws Exception If anything fails.
     */
    @Test
    public void testOumUou4_soap() throws Exception {
        ...
        // root attributes
        final Document toBeUpdatedDocument =
            (Document) deleteAttribute(createdDocument, XPATH_ORGANIZATIONAL_UNIT_OBJID);
