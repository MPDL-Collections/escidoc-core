...
public class ContainerCreateRestTest extends ContainerTestBase {
    ...
    public void testOM_CCO_1_1() throws Exception {
        ...
        if (LOGGER.isDebugEnabled()) {
            LOGGER.debug("container  " + theContainerXml);
        }
    ...
    public void testOM_CCO_13_1_rest() throws Exception {
        ...
        try {
            ...
            EscidocRestSoapTestBase.failMissingException("Creating Container with invalid object href not declined. ",
                ec);
        }
        catch (final Exception e) {
            EscidocRestSoapTestBase.assertExceptionType("Creating Container with invalid object href not declined,"
                + " properly. ", ec, e);
        }
    }
