...
public class CollaboratorSoapTest extends CollaboratorAbstractTest {
     ...
     */
    public CollaboratorSoapTest(final int handlerCode, final String userOrGroupId) throws Exception {
