...
/**
 * Test suite for the role CollaboratorModifierUpdateAnyMembers using the SOAP interface.
 *
 * @author Michael Hoppe
 */
@RunWith(Parameterized.class)
public class CollaboratorModifierUpdateAnyMembersSoapTest extends CollaboratorModifierUpdateAnyMembersAbstractTest {
     ...
     */
    public CollaboratorModifierUpdateAnyMembersSoapTest(final int handlerCode, final String userOrGroupId)
        throws Exception {
