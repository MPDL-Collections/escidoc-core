...
public class ContextAdminSoapTest extends ContextAdminAbstractTest {
     ...
     */
    public ContextAdminSoapTest(final int handlerCode, final String userOrGroupId) throws Exception {
