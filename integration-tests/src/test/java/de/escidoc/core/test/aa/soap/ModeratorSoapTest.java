...
/**
 * Test suite for the role Moderator using the SOAP interface.
 *
 * @author Torsten Tetteroo
 */
@RunWith(Parameterized.class)
public class ModeratorSoapTest extends ModeratorAbstractTest {
     ...
     */
    public ModeratorSoapTest(final int handlerCode, final String userOrGroupId) throws Exception {
